...
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1createEventChannel(
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1createId(JNIEnv *env,
                                                          jobject obj,
                                                          jlong channel,
                                                          jshort rdma_ps) {
  ...
  if (cm_listen_id != NULL && protection != NULL && send_cq != NULL &&
    ...
    if (ret == 0) {
      ...
      log("j2c::createQP: obj_id %llu, qpnum %u, send_wr %u, recv_wr %u \n",
          obj_id, cm_listen_id->qp->qp_num, qp_init_attr.cap.max_send_wr,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1ackCmEvent(JNIEnv *env,
                                                            jobject obj,
                                                            jint event) {
  return 0;
}
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1disconnect(JNIEnv *env,
                                                            jobject obj,
                                                            jlong id) {
  struct rdma_cm_id *cm_listen_id = NULL;
  jint ret = -1;
...
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1destroyEventChannel(
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1destroyCmId(JNIEnv *env,
                                                             jobject obj,
                                                             jlong id) {
  struct rdma_cm_id *cm_listen_id = NULL;
  jint ret = -1;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1destroyQP(JNIEnv *, jobject,
                                                           jlong id) {
  struct rdma_cm_id *cm_listen_id = NULL;
  jint ret = -1;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1destroyEp(JNIEnv *, jobject,
                                                           jlong id) {
  struct rdma_cm_id *cm_listen_id = NULL;
  jint ret = -1;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getSrcAddr(JNIEnv *env,
                                                            jobject obj,
                                                            jlong id,
                                                            jlong addr) {
  struct rdma_cm_id *cm_listen_id = NULL;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getDstAddr(JNIEnv *, jobject,
                                                            jlong id,
                                                            jlong addr) {
  struct rdma_cm_id *cm_listen_id = NULL;
  jint ret = -1;
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getContext(JNIEnv *env,
                                                            jobject obj,
                                                            jlong id) {
  struct rdma_cm_id *cm_listen_id = NULL;
  // jint cmd_fd = -1;
...
/*
 * Class:     jrdma_disni_verbs_impl_NativeDispatcher
 * Method:    _allocPd
 * Signature: (I)I
 */
JNIEXPORT jlong JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1allocPd(JNIEnv *env,
                                                         jobject obj,
                                                         jlong ctx) {
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1createCompChannel(JNIEnv *env,
                                                                   jobject obj,
                                                                   jlong ctx) {
  struct ibv_context *context = NULL;
  unsigned long long obj_id = -1;
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1createCQ(
    JNIEnv *env, jobject obj, jlong ctx, jlong channel, jint ncqe,
    jint comp_vector) {
  struct ibv_context *context = NULL;
  ...
  if (context != NULL && comp_channel != NULL) {
    struct ibv_cq *cq =
        ibv_create_cq(context, _ncqe, NULL, comp_channel, _comp_vector);
    if (cq != NULL) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1expPrefetchMr(
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getCqEvent(JNIEnv *env,
                                                            jobject obj,
                                                            jlong channel,
                                                            int timeout) {
  struct ibv_comp_channel *comp_channel = NULL;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1reqNotifyCQ(JNIEnv *env,
                                                             jobject obj,
                                                             jlong cq,
                                                             jint solicited) {
  struct ibv_cq *completionqueue = NULL;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1ackCqEvent(JNIEnv *env,
                                                            jobject obj,
                                                            jlong cq,
                                                            jint nevents) {
  struct ibv_cq *completionqueue = NULL;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1destroyCompChannel(
    JNIEnv *env, jobject obj, jlong channel) {
  struct ibv_comp_channel *comp_channel = NULL;
  jint ret = -1;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1deallocPd(JNIEnv *env,
                                                           jobject obj,
                                                           jlong pd) {
  struct ibv_pd *protection = NULL;
  jint ret = -1;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1destroyCQ(JNIEnv *env,
                                                           jobject obj,
                                                           jlong cq) {
  struct ibv_cq *completionqueue = NULL;
  jint ret = -1;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getQpNum(JNIEnv *env,
                                                          jobject obj,
                                                          jlong obj_id) {
  jint qpnum = -1;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getContextFd(JNIEnv *env,
                                                              jobject obj,
                                                              jlong obj_id) {
  jint cmd_fd = -1;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getContextNumCompVectors(
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getPdHandle(JNIEnv *env,
                                                             jobject obj,
                                                             jlong pd) {
  jint handle = -1;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getSockAddrInSize(JNIEnv *,
                                                                   jobject) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getIbvRecvWRSize(JNIEnv *,
                                                                  jobject) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getIbvSendWRSize(JNIEnv *,
                                                                  jobject) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getIbvSgeSize(JNIEnv *,
                                                               jobject) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getIbvWCSize(JNIEnv *,
                                                              jobject) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getRemoteAddressOffset(
    JNIEnv *, jobject) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_ibm_disni_verbs_impl_NativeDispatcher__1getRKeyOffset(JNIEnv *,
                                                               jobject) {
