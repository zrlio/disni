 ...
 */
public abstract class RdmaCqProcessor<C extends RdmaClientEndpoint> extends RdmaCqProvider implements Runnable {
	...
	public synchronized void unregister(RdmaClientEndpoint endpoint) throws IOException {
