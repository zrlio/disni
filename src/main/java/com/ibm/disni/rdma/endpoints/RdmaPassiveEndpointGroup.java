 ...
 */
public class RdmaPassiveEndpointGroup<C extends RdmaClientEndpoint> extends RdmaEndpointGroup<C> {
	...
	public RdmaPassiveEndpointGroup<RdmaClientEndpoint> createDefaultGroup() throws IOException{
		return createDefaultGroup(0, 128, 4, 128);
	}
	
	public RdmaPassiveEndpointGroup<RdmaClientEndpoint> createDefaultGroup(int timeout, int maxWR, int maxSge, int cqSize) throws IOException{
		RdmaPassiveEndpointGroup<RdmaClientEndpoint> group = new RdmaPassiveEndpointGroup<RdmaClientEndpoint>(timeout, maxWR, maxSge, cqSize);
	...
	protected class RawEndpointFactory implements RdmaEndpointFactory<RdmaClientEndpoint> {
		RdmaPassiveEndpointGroup<RdmaClientEndpoint> group;
		
		public RawEndpointFactory(RdmaPassiveEndpointGroup<RdmaClientEndpoint> group){
			this.group = group;
		}
		
		public RdmaClientEndpoint createClientEndpoint(RdmaCmId idPriv) throws IOException {
			return new RdmaClientEndpoint(group, idPriv);
		}
	}
